...
/// Win HR color palette — Clean White + Navy Blue professional theme.
class AppColors {
  AppColors._();
  ...
  static const Color activeFg = Color(0xFF16A34A);
  static const Color retiredBg = Color(0xFFFEF3C7);
  static const Color retiredFg = Color(0xFFD97706);
  static const Color deceasedBg = Color(0xFFFEE2E2);
  static const Color deceasedFg = Color(0xFFDC2626);
}
